        ...
        .menu-wrap{
          .menu-item{
            ...
            a{
              ...
              color: #ffffff;
              padding-left: 30px;
              display: block;  //将a进行填满 这样图标才能往右移
              &:after{
                content: ' ';
                position: absolute;
                right: 30px; //本身a就是相对定位，而且after会相对去a来进行定位的
                top: 17.5px;
            ...
            .children{
              ...
              ul{
                display: flex; //用flex布局控制两边对齐
                justify-content: space-between; //实现两边对齐的效果
                height: 75px; //chidren的高度是451除以6 得到每行的高度
                li{
                  height: 75px;
                  line-height: 75px;
                  // width: 241px; //962除以4列 得到每列的宽度
                  flex: 1;
                  padding-left: 23px;
                }
                a{
    ...
    .product-box{
      ...
      .wrapper{
        ...
        .list-box{
          .list{
            @include flex();
            width: 986px; //整个盒子的宽度1226减去左边图片的宽度224再减图片的边距
            margin-bottom: 14px; //第一行离下面的像素是14
            &:last-child{
              margin-bottom: 0;
            }
            .item{
              ...
              text-align: center;
              span{
                display: inline-block; //这里是因为字体的大小被撑开 所以要给他个方块
                width: 67px;
                height: 24px;
                font-size: 14px;
                line-height: 24px;
